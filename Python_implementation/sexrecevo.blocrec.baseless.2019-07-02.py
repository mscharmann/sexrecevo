...
#	print "mutating"
	dispersed_pop_gametes, variant_idxes, variant_effects, variant_areas = mutate_gametes(dispersed_pop_gametes, gridlength_x, gridlength_y, mu , chrom_length, variant_idxes, variant_effects, variant_areas, new_area_size, new_effect)
#	print "mating"
