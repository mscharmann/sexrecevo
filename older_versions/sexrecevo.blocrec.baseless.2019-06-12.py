...
def mutate_gametes(ingametes, grid_xlen, grid_ylen, mu, chrom_length, variant_idxes, variant_effects, variant_areas):
...
nominal_overall_rec_rate_per_site = 2e-7 # can be at most 1 event; => max(nominal_overall_rec_rate_per_site) = 1/sequence_length
# mutation rate
mu = 2.5e-7
...
pop, variant_idxes, variant_effects, variant_areas = make_dioecious_pop (N_per_cell, gridlength_x , gridlength_y, sexdet_site)
#pop, variant_idxes, variant_effects, variant_areas = make_sanitycheck_pop (N_per_cell, gridlength_x , gridlength_y, sexdet_site)
nominal_rec_rate_array = numpy.array([nominal_overall_rec_rate_per_site]*chrom_length)

for generation in range(10000+1):
...
#	print "mutating"
	dispersed_pop_gametes, variant_idxes, variant_effects, variant_areas = mutate_gametes(dispersed_pop_gametes, gridlength_x, gridlength_y, mu , chrom_length, variant_idxes, variant_effects, variant_areas)
#	print "mating"
